...
<body>
 ...
 <div class="menur1">
    <div class="menutitle">
      <h1 class="menutitlehead"></h1>
      <span class="menutitledesc"></span>
    </div>
  </div>
...
<div class="menur2">
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="card1.png" alt="Avatar" style="width:22rem;height:22rem;">
    </div>
    <div class="flip-card-back">
      <h5 class="card-title"><b>HOT ITALIAN BEVERAGES</b></h5>
      <p class="card-text1">If you're trying to fuel your body and soul with things wholesome and healthy, these hot drinks taste indulgent
        ...
        <div class="col">
         ...
         <div class="flip-card-inner">
        <div class="flip-card-front">
         <img src="bg16.jpg" alt="Avatar" style="width:22rem;height:22rem;">
    </div>
    <div class="flip-card-back">
              <h5 class="card-title"><b>ITALIAN PIZZA</b></h5>
              <p class="card-text1">Pizza is a dish of Italian origin consisting of usually round, flat base or leavened wheat-based dough, topped with tomatoes, cheese and often various other ingredients, which is then baked in a wood-fired oven. Loaded with toppings, cheese and flavour. You will never want any other pizza again.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="ni.jpg" alt="Avatar" style="width:22rem;height:22rem;">
    </div>
    <div class="flip-card-back">
              <h5 class="card-title"><b>PASTA</b></h5>
              <p class="card-text1">Pasta is a type of food typically made from an unleavened dough of wheat flour mixed with water or eggs, and formed into sheets or other shapes, then cooked by boiling or baking. Spaghetti, Macaroni, Noodles are the different types of Pasta.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="img23.jpg" alt="Avatar" style="width:22rem;height:22rem;">
    </div>
    <div class="flip-card-back">
              <h5 class="card-title"><b>DESSERTS</b></h5>
              <p class="card-text1">Desserts is a sweeter course that concludes a meal. This includes a range of courses ranging from fruits or dried nuts to multi-ingredient cakes and pies.  They are the fairy tales of the kitchen, a happily-ever-after to supper.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-7 menucol">
        <div class="menur3">
          <div class="row menucatr1" id="hb">
            <span class="menutitlehb" >Hot Italian Beverages</span><br/>
          ...
          <div class="row menucatr2" id="si">
            <span class="menutitlesi" >Italian Pizza</span><br />
          ...
          <div class="row menucatr3" id="ni">
            <span class="menutitleni">Pasta</span></br />
